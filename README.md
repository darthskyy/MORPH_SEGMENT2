...
## Acknowledgements
Shijie Wu for the code base for their open-source [neural transducer](https://github.com/shijie-wu/neural-transducer){:target="_blank"} used in this project.

Aaron Daniels, Tumi Moeng and Sheldon Reay for their open-source [MORPH_SEGMENT](https://github.com/DarkPr0digy/MORPH_SEGMENT){:target="_blank"} repo and evaluation scripts. Most especially for beginning the task which would have been difficult to implement without inspiration from their research.
